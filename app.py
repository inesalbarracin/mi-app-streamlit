...
def load_datasets():
    df = pd.read_csv('/Users/inesalbarracin/Documents/Mim/4to cuatri/Mlos/MaterialClase1/Streamlit/digit-recognizer/train.csv')
    y = df['label']
    df.drop('label', axis=1, inplace=True)
    df_test = pd.read_csv('/Users/inesalbarracin/Documents/Mim/4to cuatri/Mlos/MaterialClase1/Streamlit/digit-recognizer/test.csv')
    return df, y, df_test
